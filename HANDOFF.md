...
455 tests, up from 300; all seven projects build with no warnings.
...
All seven projects build with **0 warnings** and the suite passes **455 tests**, up from 57 when
this began.
...
tests/CoreLib.Tests/  455 tests: crypto, key agreement, identity, key storage, the registry,
